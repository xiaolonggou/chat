          ...
          MaterialPageRoute(
            builder: (context) => EditScenePage(
              scene: Scene(
                ...
                userId: 1, // assuming userId is set correctly
                name: null, // Can be nullable
                description: null, // Can be nullable
                mood: null, // Can be nullable
                topic: null, // Can be nullable
...
class SceneListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Dismissible(
        key: Key(scene.id?.toString() ?? 'scene-${scene.name ?? 'Unnamed'}'),
